...
<table style="width: 100%;">
    <tr>
        <td style="width: 33%;">
            ...
            <strong>YouTube Video Downloader with <code>yt-dlp</code></strong>
        ...
        <td style="width: 33%;">
            ...
            <strong>Supermarket Mercadona Scraper</strong>
        ...
        <td style="width: 33%;">
            ...
            <strong>Predicting the market value of football players</strong>
...
<table style="width: 100%;">
    <tr>
        <td style="width: 33%;">
            ...
            <strong>TikTok Video Downloader using <code>yt-dlp</code></strong>
            ...
            <a href="https://github.com/vgvr0/TikTok-Video-Downloader-using-Python-and-yt-dlp">Repo</a>
        </td>
        <td style="width: 33%;">
            <h3>Supermarket ECI Scraper</h3>
            ...
            <strong>Supermarket ECI Scraper</strong>
            <p>A web scraping various from an online supermarket (elcorteingles.es) and saving product details into a CSV file.</p>
            <a href="https://github.com/vgvr0/el-corte-ingles-supermarket-scraper">Repo</a>
        </td>
        <td style="width: 33%;">
            <h3>SQL Complete Referenced</h3>
            <img src="https://www.stonebranch.com/integration-hub/media/3c/64/66/1636642258/Stonebranch_SQL_Vendor_Product_Logo.svg" alt="Top Value Logo" style="width: 100%;">
            <strong>SQL Complete Referenced</strong>
            <p>Examples of the main categories of SQL functions, including aggregation functions...</p>
